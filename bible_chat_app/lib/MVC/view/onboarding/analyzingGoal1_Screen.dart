...
import 'package:bible_chat_app/MVC/view/onboarding/analyzingGoal2_Screen.dart';
...
class Analyzinggoal1screen extends StatelessWidget {
  Analyzinggoal1screen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ThemeHelper>(initState: (state) {
      profilepercentage = onboardingcontroller.questions
              .firstWhere(
                (e) => e.id == 5,
              )
              .weight! +
          ...
          onboardingcontroller.profileloading.value =
              double.parse(onboardingcontroller.questions
                  ...
                  double.parse(onboardingcontroller.questions
                      ...
                      .weight
                      .toString());
          onboardingcontroller.Goalsloading.value = 1.0;
        },
      );
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                onboardingcontroller.questions.firstWhere((e) => e.id == 7,).questionText,
