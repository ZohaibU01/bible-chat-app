...
import 'package:bible_chat_app/MVC/view/onboarding/profileCompletion2_Screen.dart';
...
class Profilecompletion1screen extends StatelessWidget {
  Profilecompletion1screen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ThemeHelper>(initState: (state) {
      Timer(
        ...
        () {
          onboardingcontroller.profileloading.value = 01.0;
        },
      );
